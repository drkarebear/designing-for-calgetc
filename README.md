...
- Home 🏠
- Areas & Standards 🗺️
- Design or Revise a Course ✏️
- Check My Cal-GETC Area ✅
- Approval & ASSIST 🔎
- Changes 🔄
- FAQs ❓
...
- Increased card spacing and line-height in the Areas directory.
- Expanded Area 1/3/5 overview CTAs to include both the subarea code and name.
